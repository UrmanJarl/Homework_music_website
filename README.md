**Обязательная часть** — запросы выполнены в файле homework_music_website.sql
...
**Дополнительное задание** — выполнено в файле add_task_employee.sql
...
_Примечание: начальник — тоже сотрудник. Отдел можно хранить строкой, можно идентификатором — не принципиально._
